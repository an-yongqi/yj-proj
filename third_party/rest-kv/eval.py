...
# Mapping datasets to their corresponding metric function
dataset2metric = {
...
if __name__ == '__main__':
    ...
    narrativeqa_dir = os.path.join(args.results_dir, "narrativeqa")
    # Get all filenames except metrics.json
    json_files = [f for f in os.listdir(narrativeqa_dir) if f.endswith('.json') and f != "metrics.json"]
