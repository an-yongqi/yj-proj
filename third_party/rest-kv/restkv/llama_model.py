...
from restkv.restkv_utils import init_restkv,init_pyramidkv,init_snapkv,init_CAM,init_H2O, init_ablation
from restkv.restkv_utils import init_StreamingLLM,init_l2norm, init_adakv, init_headkv, init_restkv
import math
try:
...
def llama_sdpa_attn_forward_RestKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.Tensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def llama_flash_attn2_forward_RestKV(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.LongTensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
...
def llama_flash_attn2_forward_Ablation(
    self,
    hidden_states: torch.Tensor,
    attention_mask: Optional[torch.LongTensor] = None,
    position_ids: Optional[torch.LongTensor] = None,
